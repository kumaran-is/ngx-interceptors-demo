...
import { ProgressHttpInterceptor } from '@app/core/interceptors/progress-http.interceptor';

export const interceptorProviders = [
  { provide: HTTP_INTERCEPTORS, useClass: RequestTimerInterceptor, multi: true },
  { provide: HTTP_INTERCEPTORS, useClass: ProgressHttpInterceptor, multi: true },
